...
{
	return mysqli_query(connection(),"INSERT INTO laptops(owner_id,brand,model,header,processor,generation,clock_speed,cache,display_type,display_size,display_resolution,touch,ram_type,ram,storage,graphics_chipset,graphics_memory,networking,display_port,audio_port,usb_port,battery,weight,color,operating_system,others,part_no,origin,assemble,warranty,upcoming,gifts,regular_price,special_price,discount_price,quantity,status) VALUES('$u_id','$brand','$model','$header','$processor','$gen','$clock_speed','$cache','$d_type','$d_size','$d_res','$touch','$r_type','$ram','$storage','$g_chipset','$g_memory','$networking','$d_port','$a_port','$u_port','$battery','$weight','$color','$os','$others','$part_no','$origin','$assemble','$warranty','$upcoming','$gifts','$r_price','$s_price','$d_price','$quantity','$status')");
}
