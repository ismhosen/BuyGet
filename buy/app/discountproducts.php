				...
				<div class="modal-content">
							...
							?>
								<tr>
									<form method="POST" action="carthandler.php?c_id=<?php echo $row['c_id'];?>">
										...
										<td><button type="submit" name="save_discount" class="btn btn-success fa fa-check"></button></td>
										<td><button type="submit" name="delete_discount" class="btn btn-danger fa fa-trash"></button></td>
					...
					<div class="modal-footer">
						...
						<form method="POST" action="carthandler.php?id=<?=$id?>" style="margin:0px; padding:0px; display:inline;">		
							<button type="submit" class="btn btn-danger pull-left fa fa-trash" name="delete_all_discount">&nbsp; Clear ALL</button>
						</form>
					</div>
				</div>
			</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
							...
							?>
								<tr>
									<form method="POST" action="carthandler.php?b_id=<?php echo $row['b_id'];?>">
										...
										<td><button type="submit" name="delete_bookmark_discount" class="btn btn-danger fa fa-trash"></button></td>
										<td><a href="product_details.php?id=<?php echo $row['product_id'];?>&header=<?php echo $row['header'];?>"><button type="button" name="details" class="btn btn-default fa fa-info-circle"></button></a></td>
										<!-- <td><button type="submit" name="save" class="btn btn-success fa fa-check"></button></td> -->
									</form>
								</tr>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						<form method="POST" action="carthandler.php?id=<?=$id?>" style="margin:0px; padding:0px; display:inline;">		
							<button type="submit" class="btn btn-danger pull-left fa fa-trash" name="delete_bookmark_all_discount">&nbsp; Clear ALL</button>
						</form>
					</div>
				</div>
			</div>
